...
# === CONFIG ===
BOT_TOKEN = '8455666531:AAHw_32Q29kmmlRV4GvKsSpZbS4O65s0OpY'
CHAT_ID = '-1002939166490'
        ...
        for row in data['aaData']:
            ...
            if otp:
                ...
                if unique_key not in already_sent:
                    ...
                    text = (
                        "✨ <b>OTP {escape_html(service)} Received</b> ✨\n\n"
                        ...
                        "<b>P0WERED BY</b> <b> SEYITECH </b>"
                    )

                    keyboard = InlineKeyboardMarkup([
                        [InlineKeyboardButton("👨‍💻 <b> Bot Developer </b>", url="https://t.me/Crypto4947")],
                        [InlineKeyboardButton("🔁 <b> Backup Channel </b>", url="https://t.me/SeyitechFreeNo")]
                    ]) 
                    try:
